        ...
        <div className="glass-card" style={{ borderRadius: 'var(--radius-2xl)', overflow: 'hidden', border: '1px solid rgba(226, 232, 240, 0.5)' }}>
          ...
          <div className="table-container">
            <table>
              ...
              <tbody>
                {loading ? (
                  <tr><td colSpan="6" style={{ textAlign: 'center', padding: '40px', color: 'var(--slate-400)' }}>Loading...</td></tr>
          ...
          <div className="glass-card logs-card">
            <div className="logs-header">
              <h3 className="logs-title">
                <span className="material-icons-round" style={{ fontSize: '20px', color: 'var(--primary)' }}>history</span>
                System Logs
              </h3>
              <button className="link-primary">View All</button>
            </div>

            <div className="log-item">
              <div className="log-dot-container">
                <div className="log-dot" style={{ background: 'var(--emerald-500)' }}></div>
                <div className="log-line"></div>
              </div>
              <div>
                <p className="log-title">New chit group registered</p>
                <p className="log-meta">System • Platform Event</p>
              </div>
            </div>
            <div className="log-item">
              <div className="log-dot-container">
                <div className="log-dot" style={{ background: 'var(--primary)' }}></div>
                <div className="log-line"></div>
              </div>
              <div>
                <p className="log-title">Payment batch processed</p>
                <p className="log-meta">Finance • Automated</p>
              </div>
            </div>
            <div className="log-item">
              <div className="log-dot-container">
                <div className="log-dot" style={{ background: 'var(--amber-500)' }}></div>
              </div>
              <div>
                <p className="log-title">Member joined group</p>
                <p className="log-meta">Group • User Activity</p>
              </div>
            </div>
          </div>

          <div className="glass-card fund-card">
            <h3 className="fund-title">
              <span className="material-icons-round" style={{ fontSize: '20px', color: 'var(--primary)' }}>pie_chart</span>
              Fund Distribution
            </h3>
            ...
            <div className="fund-chart">
              <div
                className="fund-ring"
                style={{
                  background: `conic-gradient(var(--primary) 0% 45%, var(--emerald-500) 45% 70%, var(--slate-200) 70% 100%)`
                }}
              >
                <div style={{ width: '80px', height: '80px', borderRadius: '50%', background: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                  <span className="fund-ring-value">{chits.length}</span>
                  <span className="fund-ring-label">Total Groups</span>
                </div>
              </div>
            </div>
            ...
            <div className="fund-stats">
              <div className="fund-stat">
                <p className="fund-stat-label">Active</p>
                <p className="fund-stat-value" style={{ color: 'var(--primary)' }}>{activeChits.length}</p>
              </div>
              <div className="fund-divider"></div>
              <div className="fund-stat">
                <p className="fund-stat-label">Completed</p>
                <p className="fund-stat-value" style={{ color: 'var(--emerald-500)' }}>{chits.length - activeChits.length}</p>
              </div>
            </div>
          </div>
        </div>
